...
import { Activity, AlertTriangle, CheckCircle, FileText, Plus, Search, LogOut, History as HistoryIcon, Camera } from 'lucide-react';
            ...
            <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                ...
                <div className="mb-6 flex flex-wrap gap-3 items-center justify-between">
                    ...
                    <div className="flex space-x-3">
                        ...
                        {user?.role === 'admin' && (
                            <>
                                ...
                                <button
                                    ...
                                    className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
                                >
                                    <AlertTriangle className="-ml-1 mr-2 h-5 w-5 text-red-500" />
                                    Settings / Reset
                                </button>
                                <button
                        ...
                        {/* Buttons for Everyone (or logic can vary) */}
                        <button
                            onClick={() => router.push('/admin/history')}
                            className="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50"
                        >
                            <HistoryIcon className="-ml-1 mr-2 h-5 w-5 text-indigo-500" />
                            Log
                        </button>
                    </div>
                </div>
